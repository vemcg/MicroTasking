...
val versionBase = providers.gradleProperty("buildVersionBase").orElse("0.2.0").get()
...
dependencies {
    ...
    // The one-shot "retry the pending Sheet writes when the network returns" job (PendingFlushWorker).
